"""
OT-2 RL Training - Simple Working Version
"""
...
from ot2_gym_wrapper_4 import OT2GymEnv
        ...
        for i, done in enumerate(dones):
            if done:
                ...
                if i < len(infos):
                    ...
                    # Extract metrics (your wrapper uses 'distance')
...
# ClearML Setup
# ============================================================================
task_name = f'ot2_rl_simple_{timestamp}'
